...
<p align="center">
  I build fast, polished web apps with React and Next.js, with a soft spot for smooth UI, motion and 3D on the web.
</p>
...
- 🎬 I enjoy hand-built animation and interactive 3D with **Three.js, GSAP** and plain `requestAnimationFrame`
- 🛠️ On the backend I use **Node.js, Express, Prisma and PostgreSQL**
- 💬 Ask me about React, UI animation, or Tailwind CSS

### 🛠️ Tech stack

<p>
  <img src="https://skillicons.dev/icons?i=react,nextjs,ts,js,html,css,tailwind,threejs,vite,nodejs,express,prisma,postgres,git,github,vscode,webstorm&perline=9" alt="React, Next.js, TypeScript, JavaScript, HTML, CSS, Tailwind CSS, Three.js, Vite, Node.js, Express, Prisma, PostgreSQL, Git, GitHub, VS Code, WebStorm" />
</p>
